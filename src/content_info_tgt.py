...
with open(f'../project_data/{args.ratio}/tgt_{args.tgt}_src_{args.src}/tgt_description_dict.pickle', 'wb') as handle:
    pickle.dump(description_embeddings_dict, handle, protocol=pickle.HIGHEST_PROTOCOL)
    
#Saving Category embeddings
with open(f'../project_data/{args.ratio}/tgt_{args.tgt}_src_{args.src}/tgt_category_dict.pickle', 'wb') as handle:
...
with open(f'../project_data/{args.ratio}/tgt_{args.tgt}_src_{args.src}/tgt_description_dict.pickle', 'rb') as handle:
...
# Loading the dictionary
with open(f'/../project_data/{args.ratio}/tgt_{args.tgt}_src_{args.src}/tgt_category_dict.pickle', 'rb') as handle:
